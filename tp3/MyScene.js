...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.2, 0.1, 0.05, 1.0);
        this.material4.setDiffuse(0.4, 0.2, 0.1, 1.0);
        this.material4.setSpecular(0.1, 0.05, 0.025, 1.0);   
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom': 3 , 'Wood Diffuse': 4};
    }
    display() {
